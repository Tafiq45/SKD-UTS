...
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/cs
s/bootstrap.min.css" integrity="sha384-
JcKb8q3iqJ61gNV9KGb8thSsNjpSL0n8PARn9HuZOnIxN0hoP+VmmDGMN5t9UJ0 Z"
...
$hasil_cipher       = str_replace(" ", "", $_POST['ciper']);
...
while ($index_x < $panjang_ciper) {
    ...
    <form action="encrypsi_act.php" method="post" data- ajax="false"
    class="ui-body ui-body-a ui-corner-all">
    <label for="basic"> Plainteks : </label>
    <textarea class="form-control" name="plain" d="textarea-
a"><?php echo $hasil_akhir; ?></textarea>
